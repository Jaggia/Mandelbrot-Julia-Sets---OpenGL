...
//colorOut = vec4(1.0-k/double(itr), 0.5-k/double(itr), 1.0-k/double(itr), 1.0);
//      colorOut = vec4(0.0, k/double(itr), 0.0, 1.0);
//      colorOut = vec4(1.0, k/double(itr), 0.0, 1.0);
//      colorOut = vec4(0.8, 1-k/double(itr), 0.75, 1.0);
//colorOut = vec4(k/double(itr), k/double(itr), k/double(itr), 1.0);

//colorOut = vec4(1-k/double(itr), 0.0, k/double(itr), 1.0);
//colorOut = vec4(k/double(itr), 0.4, 1-k/double(itr), 1.0);
//colorOut = map_to_color(k == itr ? 1 : k/double(25));
      }